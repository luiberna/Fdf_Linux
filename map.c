...
/*   Updated: 2024/03/25 15:24:15 by luiberna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//         {
//             printf("x: %f, y: %f, z: %f\n", fdf->map->map_3d[i][j].x,
//	fdf->map->map_3d[i][j].y, fdf->map->map_3d[i][j].z);
//             j++;
//         }
//         i++;
//     }
...
void	fill_map_3d(t_fdf *fdf)
{
	...
	i = 0;
	fdf->map->map_3d = (t_map_3d **)malloc(sizeof(t_map_3d *)
			* fdf->map->height--);
	while (i < fdf->map->height)
	{
		fdf->map->map_3d[i] = (t_map_3d *)malloc(sizeof(t_map_3d)
				* fdf->map->width);
		j = 0;
		while (j < fdf->map->width)
		{
